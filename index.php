	...
	echo "
		...
		<html>
			<head>
				...
				<link rel='stylesheet' href='$homeurl/plugins/uploadfile/css/uploadfile.css'>
			...
			<body class='hold-transition skin-blue  fixed $sidebar' >
							...
							<section class='content'>";
								...
								<div class='alert alert-info alert-dismissible'>
									...
									<div class='col-md-12'>
										...
										$mapelQ = mysql_query("SELECT * FROM ujian WHERE (id_pk='$idpk' or id_pk='0') AND  level='$level'   AND sesi='$idsesi'  AND status='1' ORDER BY tgl_ujian ");
												...
												<div class='col-md-6'>
													<div class='box box-solid'>
														<div class='box-header bg-red'>
															...
															<div class='btn-group'>
																<a href='$homeurl'><span class='btn btn-sm btn-flat btn-default active'>Kembali</span></a>
											...
											<div class='col-md-12'>
												<div class='box box-solid'>
													<div class='box-header bg-teal'>
														<h3 class='box-title'><span class='btn btn-sm btn-flat bg-red'><b>NO</b></span><span class='btn btn-sm btn-flat bg-green' id='displaynum'><b>$no_next</b></span></h3>
														<div class='box-title pull-right'>
															<div class='btn-group'>
																<span class='btn btn-sm btn-flat bg-gray active'>WAKTU</span>
																<span class='btn btn-sm btn-flat bg-red'><b id='countdown'><span id='htmljam' >$jam</span>:<span id='htmlmnt'>$mnt</span>:<span id='htmldtk'>$dtk</span></b></span>
															</div>
															<div class='btn-group'>
															<form action='' method='post'>
													...
													<div id='loadsoal'>
														<div class='box-body'>
															<div class='callout'>$soal[soal]</div>
														...
														<div class='box-footer navbar-fixed-bottom'>
															...
															<tr><td>
																<div class='col-md-4 '>
																	<button id='move-prev' class='btn btn-flat btn-default' onclick=loadsoal($id_mapel,$id_siswa,$no_prev,1)><i class='fa fa-chevron-left'></i> <span class='hidden-xs'>SOAL SEBELUMNYA</span></button>
																...
																<div class='col-md-4 '>
																	...
																	<button id='move-next' class='btn btn-flat btn-primary' onclick=loadsoal($id_mapel,$id_siswa,$no_next,1)><span class='hidden-xs'>SOAL SELANJUTNYA</span> <i class='fa fa-chevron-right'></i></button>
																</div></td>
																</tr>
															</table>
														</div>
													  ...
													  <div class='col-md-12' >
															...
															echo "</div >";
																for($n=0;$n<$soalpg;$n++) {
																	...
																	echo "
																		<a style='min-width:40px;height:40px' class='btn btn-app bg-$color' id='badge$id_soal' onclick=loadsoal($id_mapel,$id_siswa,$n,1)> $nomor <span id='jawabtemp$id_soal' class='badge bg-red'>$ragu[jawaban]</span></a>
																	";
																}
																echo "
															</div>
				...
				<script src='$homeurl/plugins/uploadfile/js/jquery.uploadfile.min.js'></script>
