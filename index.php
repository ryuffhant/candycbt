			...
			if (in_array($siswa['id_kelas'], $datakelas) or in_array('semua', $datakelas)) { //cek kelas
				...
				echo "
																		<tr>
																			...
																			<td class='hidden-xs' align='center'><small class='label bg-red'>$mapelx[kode_ujian]</small></td>
								...
								<div class='row'>
									<div class='col-md-12'>
										<div class='box box-solid'>
											...
											<tr><th >Nama Ujian</th><td width='10'>:</td><td>$nilai[kode_ujian]</td></tr>
											</table><br>
											<div class='table-responsive'>
												<table id='example1' class='table table-bordered table-striped'>
													...
													<tbody>";
		$nilaix = mysql_query("SELECT * FROM jawaban WHERE id_siswa='$id_siswa' and id_ujian='$ac' and jenis='1' ");
										...
										<div class='row' style='margin-right:-25px;margin-left:-25px;'>
											<div class='col-md-12'>
												<div class='box box-solid'>
													...
													<div id='divujian'><span style='display:none' id='htmlujianselesai' >$ujianselesai</span></div>
