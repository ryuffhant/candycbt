...
-- Dumping structure for table cbtcandy25r2.berita
...
-- Dumping data for table cbtcandy25r2.berita: ~0 rows (approximately)
DELETE FROM `berita`;
/*!40000 ALTER TABLE `berita` DISABLE KEYS */;
/*!40000 ALTER TABLE `berita` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.hasil_jawaban
...
-- Dumping data for table cbtcandy25r2.hasil_jawaban: ~0 rows (approximately)
DELETE FROM `hasil_jawaban`;
/*!40000 ALTER TABLE `hasil_jawaban` DISABLE KEYS */;
/*!40000 ALTER TABLE `hasil_jawaban` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.jawaban
...
-- Dumping data for table cbtcandy25r2.jawaban: ~0 rows (approximately)
DELETE FROM `jawaban`;
/*!40000 ALTER TABLE `jawaban` DISABLE KEYS */;
/*!40000 ALTER TABLE `jawaban` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.jenis
...
-- Dumping data for table cbtcandy25r2.jenis: ~4 rows (approximately)
DELETE FROM `jenis`;
...
-- Dumping structure for table cbtcandy25r2.kelas
...
-- Dumping data for table cbtcandy25r2.kelas: ~0 rows (approximately)
DELETE FROM `kelas`;
/*!40000 ALTER TABLE `kelas` DISABLE KEYS */;
/*!40000 ALTER TABLE `kelas` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.level
...
-- Dumping data for table cbtcandy25r2.level: ~0 rows (approximately)
DELETE FROM `level`;
/*!40000 ALTER TABLE `level` DISABLE KEYS */;
/*!40000 ALTER TABLE `level` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.log
...
-- Dumping data for table cbtcandy25r2.log: ~0 rows (approximately)
DELETE FROM `log`;
/*!40000 ALTER TABLE `log` DISABLE KEYS */;
/*!40000 ALTER TABLE `log` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.login
...
-- Dumping data for table cbtcandy25r2.login: ~0 rows (approximately)
DELETE FROM `login`;
/*!40000 ALTER TABLE `login` DISABLE KEYS */;
/*!40000 ALTER TABLE `login` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.mapel
...
-- Dumping data for table cbtcandy25r2.mapel: ~0 rows (approximately)
DELETE FROM `mapel`;
/*!40000 ALTER TABLE `mapel` DISABLE KEYS */;
/*!40000 ALTER TABLE `mapel` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.mata_pelajaran
...
-- Dumping data for table cbtcandy25r2.mata_pelajaran: ~0 rows (approximately)
DELETE FROM `mata_pelajaran`;
/*!40000 ALTER TABLE `mata_pelajaran` DISABLE KEYS */;
/*!40000 ALTER TABLE `mata_pelajaran` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.nilai
...
-- Dumping data for table cbtcandy25r2.nilai: ~0 rows (approximately)
DELETE FROM `nilai`;
/*!40000 ALTER TABLE `nilai` DISABLE KEYS */;
/*!40000 ALTER TABLE `nilai` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.pengacak
...
-- Dumping data for table cbtcandy25r2.pengacak: ~0 rows (approximately)
DELETE FROM `pengacak`;
/*!40000 ALTER TABLE `pengacak` DISABLE KEYS */;
/*!40000 ALTER TABLE `pengacak` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.pengacakopsi
...
-- Dumping data for table cbtcandy25r2.pengacakopsi: ~0 rows (approximately)
DELETE FROM `pengacakopsi`;
/*!40000 ALTER TABLE `pengacakopsi` DISABLE KEYS */;
/*!40000 ALTER TABLE `pengacakopsi` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.pengawas
...
-- Dumping data for table cbtcandy25r2.pengawas: ~12 rows (approximately)
...
-- Dumping structure for table cbtcandy25r2.pengumuman
...
-- Dumping data for table cbtcandy25r2.pengumuman: ~0 rows (approximately)
DELETE FROM `pengumuman`;
/*!40000 ALTER TABLE `pengumuman` DISABLE KEYS */;
/*!40000 ALTER TABLE `pengumuman` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.pk
...
-- Dumping data for table cbtcandy25r2.pk: ~0 rows (approximately)
DELETE FROM `pk`;
/*!40000 ALTER TABLE `pk` DISABLE KEYS */;
/*!40000 ALTER TABLE `pk` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.ruang
...
-- Dumping data for table cbtcandy25r2.ruang: ~0 rows (approximately)
DELETE FROM `ruang`;
/*!40000 ALTER TABLE `ruang` DISABLE KEYS */;
/*!40000 ALTER TABLE `ruang` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.savsoft_options
...
-- Dumping data for table cbtcandy25r2.savsoft_options: ~0 rows (approximately)
DELETE FROM `savsoft_options`;
/*!40000 ALTER TABLE `savsoft_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `savsoft_options` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.savsoft_qbank
...
-- Dumping data for table cbtcandy25r2.savsoft_qbank: ~0 rows (approximately)
DELETE FROM `savsoft_qbank`;
/*!40000 ALTER TABLE `savsoft_qbank` DISABLE KEYS */;
/*!40000 ALTER TABLE `savsoft_qbank` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.server
...
-- Dumping data for table cbtcandy25r2.server: ~0 rows (approximately)
DELETE FROM `server`;
/*!40000 ALTER TABLE `server` DISABLE KEYS */;
/*!40000 ALTER TABLE `server` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.sesi
...
-- Dumping data for table cbtcandy25r2.sesi: ~0 rows (approximately)
DELETE FROM `sesi`;
/*!40000 ALTER TABLE `sesi` DISABLE KEYS */;
/*!40000 ALTER TABLE `sesi` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.session
...
-- Dumping data for table cbtcandy25r2.session: ~0 rows (approximately)
DELETE FROM `session`;
/*!40000 ALTER TABLE `session` DISABLE KEYS */;
/*!40000 ALTER TABLE `session` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.setting
...
-- Dumping data for table cbtcandy25r2.setting: ~0 rows (approximately)
DELETE FROM `setting`;
...
-- Dumping structure for table cbtcandy25r2.siswa
...
-- Dumping data for table cbtcandy25r2.siswa: ~0 rows (approximately)
DELETE FROM `siswa`;
/*!40000 ALTER TABLE `siswa` DISABLE KEYS */;
/*!40000 ALTER TABLE `siswa` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.soal
...
-- Dumping data for table cbtcandy25r2.soal: ~0 rows (approximately)
DELETE FROM `soal`;
/*!40000 ALTER TABLE `soal` DISABLE KEYS */;
/*!40000 ALTER TABLE `soal` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.token
...
-- Dumping data for table cbtcandy25r2.token: ~0 rows (approximately)
DELETE FROM `token`;
/*!40000 ALTER TABLE `token` DISABLE KEYS */;
/*!40000 ALTER TABLE `token` ENABLE KEYS */;

-- Dumping structure for table cbtcandy25r2.ujian
...
-- Dumping data for table cbtcandy25r2.ujian: ~0 rows (approximately)
DELETE FROM `ujian`;
