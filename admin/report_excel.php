...
<table border='1'>
	...
	$siswaQ = mysqli_query($koneksi, "SELECT * FROM siswa a join nilai b ON a.id_siswa=b.id_siswa where b.id_ujian='$id_ujian' ORDER BY id_kelas ASC");
	$betul = array();
	$salah = array();
...
<table border='1'>
	...
	$soalq = mysqli_query($koneksi, "SELECT * FROM soal a join ujian b ON a.id_mapel=b.id_mapel  ORDER BY nomor ASC");
