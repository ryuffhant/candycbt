	...
	echo "
		...
		<html>
			<head>
				...
				<link rel='stylesheet' href='$homeurl/dist/css/skins/skin-blue-light.min.css'/>
			...
			<div class='loader'></div>
						...
						echo "		<div class='modal fade' id='tambahjadwal' style='display: none;'>
											...
											<div class='modal-content'>
												...
												<form action='' method='post'>
															...
															<div class='col-md-6'>
																...
																<input type='text' name='tgl_ujian'   class='tgl form-control' required='true'/>
															</div>
															
															
															<div class='col-md-6'>
																<label>Tanggal Waktu Expired</label>
																<input type='text' name='tgl_selesai'   class='tgl form-control' required='true'/>
															</div>
															</div>                                                     
															</div>
									...
									<div class='row'>
										...
										<div class=''>
												...
												$waktu=$waktu[1];
												$status= $_POST['status'];
												$exec = mysql_query("UPDATE ujian SET nama='$nama',tgl_ujian='$tglujian',tgl_selesai='$tglselesai',waktu_ujian='$waktu',lama_ujian='$lama',status='$status' WHERE id_ujian='$idujian'");
												...
												$tgl=$tgl[0];
														...
														echo "
															...
															<div class='form-group'>
																...
																<input  name='tgl_ujian' value='$mapel[tgl_ujian]'  class='tgl form-control' required='true'/>
															</div>
															<div class='form-group'>
																<label>Tanggal Selesai</label>
																<input  name='tgl_selesai' value='$mapel[tgl_selesai]'  class='tgl form-control' required='true'/>
															</div>
															<div class='form-group'>
											...
											echo "<div class='modal fade' id='tambahbanksoal' style='display: none;'>
													...
													<form action='' method='post'>	
															...
															<div class='form-group'>
																...
																<div class='col-md-4'>
																<label>Soal Tampil</label>
																<input type='number' name='tampil_pg' class='form-control'  required='true'/>
																</div>
																</div>
															</div>
															<div class='form-group'>
																...
																<div class='col-md-4'>
																<label>Jumlah Soal Essai</label>
																<input type='number' name='jml_esai' class='form-control'  required='true'/>
																</div>
																<div class='col-md-4'>
																<label>Bobot Soal Essai %</label>
																...
																<div class='col-md-4'>
																<label>Soal Tampil</label>
																<input type='number' name='tampil_esai' class='form-control'  required='true'/>
																</div>
																</div>
															</div>
															<div class='form-group'>
				...
				<script>
									tinymce.init({
										...
										plugins: 'table  textcolor emoticons code codesample imagetools link image uploadimage paste',
