												...
												<table id='example1' class='table table-bordered table-striped'>
													...
													<input type='hidden' id='idm' name='idm' value='$mapel[id_mapel]'/>
															...
															<div class='form-group'>
																...
																<option value='3' ";if($mapel['opsi']==3){ echo "selected";} echo ">3</option>
																<option value='4' ";if($mapel['opsi']==4){ echo "selected";} echo ">4</option>
																<option value='5' ";if($mapel['opsi']==5){ echo "selected";} echo ">5</option>
																</select>
																</div>
																</div>
															</div>
		...
		<script>
				...
				$(document).ready(function() {
					$('#tablejenis').Tabledit({
						...
						columns: {
							identifier: [1, 'id'],
							editable: [[2, 'namajenis'],[3, 'status', '{"aktif": "aktif", "tidak": "tidak aktif"}']]
						}
					});
